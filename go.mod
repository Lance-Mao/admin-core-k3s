module github.com/Lance-Mao/admin-core-k3s
...
require (
	...
	github.com/casbin/ent-adapter v1.2.0 // indirect
...
replace github.com/zeromicro/go-zero v1.9.3 => github.com/suyuan32/simple-admin-tools v1.9.3
