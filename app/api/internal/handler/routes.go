...
import (
	...
	api "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/api"
	authority "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/authority"
	base "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/base"
	captcha "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/captcha"
	configuration "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/configuration"
	department "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/department"
	dictionary "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/dictionary"
	dictionarydetail "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/dictionarydetail"
	emaillog "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/emaillog"
	emailprovider "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/emailprovider"
	menu "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/menu"
	messagesender "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/messagesender"
	oauthprovider "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/oauthprovider"
	position "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/position"
	publicapi "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/publicapi"
	publicuser "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/publicuser"
	role "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/role"
	smslog "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/smslog"
	smsprovider "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/smsprovider"
	task "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/task"
	tasklog "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/tasklog"
	token "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/token"
	user "github.com/Lance-Mao/admin-core-k3s/app/api/internal/handler/user"
